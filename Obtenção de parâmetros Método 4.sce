...
exec("C:\Users\jvms9\OneDrive\Área de Trabalho\Comparação Al-Ajmi CBTERMO\F1\Liang CM5\Função PC-SAFT para obter Z.sce")
...
//Cálculo dos parâmetros m, epsilon_K e sigma da PC-SAFT para cada SCN (ref Liang et al. (2014))
for i = 1:length(SG)
